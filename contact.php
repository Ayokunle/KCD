                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                       <section class="main">
                            ...
                            <div id="googleMap" style="width:100%;height:400px; margin-bottom:20px;">
                        </section>
                    </div>
                    <div class="col-md-4">
                        <div class="row">
                                ...
                                <section class="main">
                                    ...
                                    <div style="padding-bottom: 50px;">
                                        <form>
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="id" placeholder="Phone Number">
                                            </div>
                                            <div class="form-group">
                                                <textarea class="form-control" rows="3" id="id" placeholder="Your Message Here"></textarea>
                                            </div>
