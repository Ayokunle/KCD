                    ...
                    <div class="col-lg-8">
                       <section class="main">
                            <div class ="main_title">
                                <h3>Management of King's Court Dublin</h3>
                            </div>
                            <div>
                                <div>
                                    <img src="img/PSG.jpg"  class ="pastor_img" style="height:130px; padding-bottom: 0px;" alt="Pastor">
                                    <b>Pastor Segun Gbadebo</b> <span style="float: right"><b>Email:</b> pastor@rccgkingscourt.org</span></br>
                                    <i>Parish Pastor</i>
                                    </br></br></br></br></br></br>
                                </div>
                                <hr>
                                <div>
                                    <img src="http://placehold.it/190x210" class ="pastor_img" style="height:130px; padding-bottom: 0px;">
                                    <b>Pastor Titi Gbadebo</b> <span style="float: right"><b>Email:</b> pastor@rccgkingscourt.org</span></br>
                                    <i>Assistant Pastor</i>
                                    </br></br></br></br></br></br>
                                </div>
                                <hr>
                                <div>
                                    <img src="http://placehold.it/190x210" class ="pastor_img" style="height:130px; padding-bottom: 0px;">
                                    <b>Pastor Solomon Popoola</b> <span style="float: right"><b>Email:</b> pastor@rccgkingscourt.org</span></br>
                                    <i>Assistant Pastor</i>
                                    </br></br></br></br></br></br>
                                </div>
                                <hr>
                                <div>
                                    <img src="http://placehold.it/190x210" class ="pastor_img" style="height:130px; padding-bottom: 0px;">
                                    <b>Pastor Phebean Adeosun</b> <span style="float: right"><b>Email:</b> pastor@rccgkingscourt.org</span></br>
                                    <i>Assistant Pastor</i>
                                    </br></br></br></br></br></br>
                                </div>
                            </div>
